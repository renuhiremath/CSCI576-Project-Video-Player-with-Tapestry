...
public class SeamCarving {
    /**
     * carveSeam() takes an image and removes a single seam from that image in
     * the desired direction.
     *
     * @param image to be carved and direction of the seam (vertical /
     * horizontal).
     * @return carved image.
     */
     ...
     * image. The energy of a pixel is the difference in the color of the pixels
     * next to it (vertical and horizontal). If the pixel is at the edge the
     * pixel itself replaces the pixel that is 'missing'.
     *
     * @param image.
    ...
    /**
     * findSeam() finds a seam given an energy table and a direction. The seam
     * is the path from bottom to top or left to right with minimum total
     * energy.
     *
    ...
    public static void performSeamCarving(BufferedImage image, String outputImageFilePath, int horizontalSeam, int verticalSeam) {
